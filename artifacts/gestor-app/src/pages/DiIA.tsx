  ...
  return (
    ...
    >
      <div
        ...
        style={{ borderBottom: "1px solid #2A2A2E", background: "#151419" }}
      >
        <div
        ...
        <div>
          ...
          <p className="text-[11px]" style={{ color: "#4A4A52" }}>
      ...
      >
        {historyLoading ? (
          <div className="flex justify-center py-8">
            <Loader2 size={20} className="animate-spin" style={{ color: "#4A4A52" }} />
          </div>
          ...
          <div className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="text-xs max-w-[260px]" style={{ color: "#4A4A52" }}>
                ...
                <div className="flex gap-2 items-end">
                  ...
                  >
                    <span
                      ...
                      style={{ background: "#A5FFD6", animationDelay: "0ms" }}
                    />
                    <span
                      className="w-1.5 h-1.5 rounded-full animate-bounce"
                      style={{ background: "#A5FFD6", animationDelay: "150ms" }}
                    />
                    <span
                      className="w-1.5 h-1.5 rounded-full animate-bounce"
                      style={{ background: "#A5FFD6", animationDelay: "300ms" }}
                    />
                  </div>
                </div>
              </div>
      ...
      <div
        ...
        style={{
          ...
          background: "linear-gradient(to top, #151419 80%, transparent)",
      ...
      >
        ...
        >
          ...
          <button
            ...
            style={{
              background: input.trim() && !sendMessage.isPending ? "#F56E0F" : "#2A2A2E",
              color: input.trim() && !sendMessage.isPending ? "#fff" : "#4A4A52",
            }}
          >
            {sendMessage.isPending ? (
